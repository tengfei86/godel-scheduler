...
// override the DispatcherConfig and DeprecatedInsecureServingOptions values for both.
...
func (o *CombinedInsecureServingOptions) applyTo(c *dispatcherappconfig.Config, componentConfig *godeldispatcherconfig.EnoDispatcherConfiguration) error {
	...
	if o.Metrics != nil && (c.DispatcherConfig.MetricsBindAddress != c.DispatcherConfig.HealthzBindAddress || o.Healthz == nil) {
...
func (o *CombinedInsecureServingOptions) ApplyToFromLoadedConfig(c *dispatcherappconfig.Config, componentConfig *godeldispatcherconfig.EnoDispatcherConfiguration) error {
	if o == nil {
		return nil
	}

...
func TestAzureDiskLimits(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.test, func(t *testing.T) {
			...
			gotStatus := p.FitsNonCSILimits(context.Background(), state, test.newPod, node)
...
func TestEBSLimits(t *testing.T) {
	...
	unboundPVCwithInvalidSCPod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			UID: types.UID("unboundPVCwithInvalidSCPod"),
		},
		Spec: v1.PodSpec{
			Volumes: []v1.Volume{
				{
	...
	unboundPVCwithDefaultSCPod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			UID: types.UID("unboundPVCwithDefaultSCPod"),
		},
		Spec: v1.PodSpec{
			Volumes: []v1.Volume{
				{
	...
	nonApplicablePod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			UID: types.UID("nonApplicablePod"),
		},
		Spec: v1.PodSpec{
			Volumes: []v1.Volume{
				{
	...
	twoDeletedPVCPod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			UID: types.UID("twoDeletedPVCPod"),
		},
		Spec: v1.PodSpec{
			Volumes: []v1.Volume{
				{
	...
	anotherDeletedPVPod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			UID: types.UID("anotherDeletedPVPod"),
		},
		Spec: v1.PodSpec{
			Volumes: []v1.Volume{
				{
	...
	anotherUnboundPVCPod := &v1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			UID: types.UID("anotherUnboundPVCPod"),
		},
		Spec: v1.PodSpec{
			Volumes: []v1.Volume{
				{

...
// CheckConflicts invoked at the filter extension point.
...
func (pl *VolumeBinding) CheckConflicts(ctx context.Context, cs *framework.CycleState, pod *v1.Pod, nodeInfo framework.NodeInfo) *framework.Status {
	if nodeInfo == nil {
...
func New(_ runtime.Object, fh handle.BinderFrameworkHandle) (framework.Plugin, error) {

...
原始数据、聚合脚本与生成图表所需的全部产物落在 `test/e2e/benchmark/results/compare/`，方法与规则详见 6.3 节，可复现。

...
separator "部署组 A — 原始 Gödel Scheduler (Shared Binder, Baseline)"
...
log_step "Step 2: 部署原始 Gödel Scheduler (godel-local:latest)"
...
separator "组 A 部署完成"
log_info "架构: 原始 Gödel — 共享 Binder (所有 Scheduler 共用 1 个 Binder)"

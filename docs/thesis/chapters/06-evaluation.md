...
![图 6-3  五调度器稳态吞吐对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-3-throughput-s3-w3.png)
...
![图 6-4  P90 调度延迟对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-4-latency-p90-s3-w3.png)


![图 6-5  P99 调度延迟对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-5-latency-p99-s3-w3.png)


![图 6-10  P99 调度延迟对比（s2, w3，均值 ± 1σ，n=3）](../figures/fig6-10-latency-p99-s2-w3.png)
...
![图 6-7  Pod E2E 延迟 P99 对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-7-e2e-latency-p99-s3-w3.png)
...
![图 6-6  绑定成功率对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-6-bind-success-rate-s3-w3.png)
...
![图 6-11  五调度器稳态吞吐对比（s4, w3, inst3，均值 ± 1σ，n=3）](../figures/fig6-11-throughput-s4-w3-inst3.png)

![图 6-12  五调度器 P99 调度延迟对比（s4, w3, inst3，均值 ± 1σ，n=3）](../figures/fig6-12-latency-p99-s4-w3-inst3.png)
...
![图 6-15  五调度器稳态吞吐对比（s3, w3, inst3，均值 ± 1σ，n=3）](../figures/fig6-15-throughput-s3-w3-inst3.png)
...
![图 6-13  五调度器稳态吞吐对比（s3, w4 极限负载, inst3，均值 ± 1σ，n=3）](../figures/fig6-13-throughput-s3-w4-inst3.png)

![图 6-14  五调度器稳态吞吐对比（s4, w5 突发洪峰, inst3，均值 ± 1σ，n=3）](../figures/fig6-14-throughput-s4-w5-inst3.png)

## 6.6　资源开销对比


![图 6-8  峰值吞吐对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-8-peak-throughput-s3-w3.png)


![图 6-9  bind_inflight 绑定并发度对比（s3, w3，均值 ± 1σ，n=3）](../figures/fig6-9-bind-inflight-s3-w3.png)

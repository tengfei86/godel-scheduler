...
取值口径：有效吞吐 = 名义工作量 / 该次 run 的完成时间（取 3 次重复的中位数）；时序类指标先按时间点对 3 条 run 取中位数，再按 §6.3 的规则取标量——延迟分位与峰值吞吐剔除首尾各 2 个采样点后取中位数，队列堆积取处理过程中的最大值；标—表示该场景未采集到有效数据。
...
| s1_w1 | 绑定成功率 | 1.00 | — | — | — | — |
| s2_w2 | 有效吞吐(pods/s) | 327 | 325 | 270 | 48.64 | 24.03 |
| s2_w2 | 峰值吞吐(pods/s) | 500 | 499 | 798 | 51.56 | 10.18 |
| s2_w2 | P90 调度延迟(s) | 0.036 | 0.032 | 0.017 | 1.97 | 16.38 |
| s2_w2 | P99 调度延迟(s) | 0.156 | 0.113 | 0.112 | 2.03 | 16.38 |
| s2_w2 | Pod E2E P99(s) | 0.232 | 0.226 | — | — | — |
| s2_w2 | 队列堆积峰值(pods) | 18.00 | 0.000 | 22875 | 0.000 | 36138 |
...
| s3_w6 | 有效吞吐(pods/s) | 333 | 263 | — | 48.54 | — |
| s3_w6 | 峰值吞吐(pods/s) | — | — | — | 50.93 | — |
| s3_w6 | P90 调度延迟(s) | — | — | — | 0.768 | — |
| s3_w6 | P99 调度延迟(s) | — | — | — | 0.826 | — |
| s3_w6 | Pod E2E P99(s) | — | — | — | — | — |
| s3_w6 | 队列堆积峰值(pods) | — | 0.000 | — | 0.000 | — |
| s3_w6 | 绑定成功率 | — | — | — | — | — |
| s3_w6_inst3 | 有效吞吐(pods/s) | 345 | 256 | — | 48.54 | — |
| s3_w6_inst3 | 峰值吞吐(pods/s) | — | — | — | 50.93 | — |
| s3_w6_inst3 | P90 调度延迟(s) | — | — | — | 0.768 | — |
| s3_w6_inst3 | P99 调度延迟(s) | — | — | — | 0.826 | — |
| s3_w6_inst3 | Pod E2E P99(s) | — | — | — | — | — |
| s3_w6_inst3 | 队列堆积峰值(pods) | 98.50 | 0.000 | — | 0.000 | — |
| s3_w6_inst3 | 绑定成功率 | — | — | — | — | — |
...
> 说明：c（kube-scheduler）、d（Volcano）、e（Koordinator）为单实例架构，其延迟分位在过载场景下存在采样偏差（见 §6.3.1），表中数值仅供参考，正文未据此做跨调度器延迟的等价性比较。
